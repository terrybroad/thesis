...
Other approaches to divergent fine-tuning are detailed in \S \ref{survey:divergent}. 
...
The process of fine-tuning shown in \S \ref{c4:sec:results} can be described as crossing the uncanny valley in reverse  (Fig. \ref{fig:c4:uncanny-valley-comparison}).

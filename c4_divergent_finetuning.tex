...
\begin{equation} 
  \max_{G}\mathbb{E}_{x\sim p_{\text{data}}(x)}[\mathbb{E}_{z\sim p_{\text{z}}(z)}[1 - \log{D(G(z))}]
...
\begin{equation} 
  \max_{G}\log(\mathbb{E}_{x\sim p_{\text{data}}(x)}[\mathbb{E}_{z\sim p_{\text{z}}(z)}[1 - \log{D(G(z))}])

...
It is clear in the visual results of the different models using the   (Eq. \ref{eq:inverted-adv-loss}; Figures \ref{fig:c4:256-OG-samples},\ref{fig:c4:512-OG-samples} \& \ref{fig:c4:1024-OG-samples}), that there are specific aspects and features of the image is optimised. 

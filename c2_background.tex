...
This emphasis on audience evaluation and domain expertise differentiates metacreation research from computational creativity, where the emphasis is on the inherent soundness of the processes encoded in the system architecture \citep{colton2008creativity}.
...
In the following subsection, the varying approaches to modelling data distributions is given in more detail. 

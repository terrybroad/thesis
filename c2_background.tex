...
MLPs can employ different non-linear activation functions, such as $\tanh$ and the sigmoid function ($\sigma$) \textbf{REF}.
...
In more complex architectures, techniques like \textit{skip connections} (\textbf{REF}) are used to connect nodes from layers that have intermediate layers in between them. 

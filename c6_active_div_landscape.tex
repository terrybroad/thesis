...
\subsubsection{Stitching Model Parameters} 
...
In recent years \textit{machine unlearning} \citep{bourtoule2021machine}, the goal of removing learned information or representations from trained machine learning models, has become a topic of active research. This usually falling under the umbrella of research into \textit{alignment} (\S \ref{c6:subsec:alignment}). 
The work presented by \cite{bau2020rewriting} could be considered an approach to machine unlearning (before the term was coined), though was demonstrated as applicable to many  tasks beyond simply erasing concepts.
...
\cite{ji2023ai} give a comprehensive survey of methods for achieving AI alignment, which is most commonly undertaken in the space of LLMs based on transformer architectures \citep{vaswani2017attention}. 

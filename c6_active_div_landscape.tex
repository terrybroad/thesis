...
In recent years \textit{machine unlearning} \citep{bourtoule2021machine}, the goal of removing learned information or representations from trained generative models, has become a topic of active research. This usually falling under the umbrella of research into \textit{alignment} (\S \ref{c6:subsec:alignment}). 

...
For three of these categories of active divergence methods, I have made major contributions, being the first to publish examples of all of these methods, (detailed in Ch.\ref{ch:unstable_eq}, Ch.\ref{ch:divergent} \& Ch.\ref{ch:net_bend}).
...
The common thread of the novel technical contributions in this thesis (presented in Ch.\ref{ch:unstable_eq}, Ch.\ref{ch:divergent} \& Ch.\ref{ch:net_bend}) are all data-free approaches to active divergence.

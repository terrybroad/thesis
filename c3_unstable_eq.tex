...
For this training setup $G_{1}$ is trained with Equation \ref{eq:g1-cosine-loss} and $G_{1}$ is trained with Equation \ref{eq:gan-g2-col-var}.
...
For this training setup $G_{1}$ is trained with Equation \ref{eq:g1-euclid-loss} and $G_{1}$ is trained with Equation \ref{eq:gan-g2-col-var}.
...
For this training setup $G_{1}$ is trained with Equation \ref{eq:g1-cosine-loss} and $G_{1}$ is trained with Equation \ref{eq:g2-euclid-loss}.
